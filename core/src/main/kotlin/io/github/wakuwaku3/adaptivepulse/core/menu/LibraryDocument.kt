            ...
            menus = listOf(
                Menu(
                    ...
                    kind = MenuKind.Interval(
                        ...
                        minBaselineSecs = config.minBaseline.inWholeSeconds.toInt(),
                        highTimeoutSecs = config.highPhaseTimeout.inWholeSeconds.toInt(),
                        recoveryTimeoutSecs = config.recoveryTimeout.inWholeSeconds.toInt(),
                    ),
                ),
            ),
